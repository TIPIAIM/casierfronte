...
const Interfcehedenrecondn = () => {
  return (
    <Container>
      <Title>Espace d'enregitrement des condamnations</Title>
      <Description>
      Plateforme agréée pour la transmission électronique :
  Intégration directe au FNCI (Fichier National des Condamnations)
   Validation automatisée des données obligatoires
...
export default Interfcehedenrecondn;
