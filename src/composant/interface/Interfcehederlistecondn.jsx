...
const Interfcehederlistecondn = () => {
  return (
    <Container>
      <Title>Relevé consolidé des condamnations</Title>
      <Description>
  Liste complète de vos condamnations judiciaires avec :<br/>
  • Documents officiels disponibles<br/>
  • Dates et types de peines<br/>
  • États d'exécution<br/>
</Description>
    </Container>
  );
};

export default Interfcehederlistecondn;
