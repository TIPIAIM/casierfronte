...
import bgImage from "../../assets/guin2.avif";
...
const Background = styled.div`
  ...
  &::after {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(120deg, rgba(0, 43, 91, 0.8), rgba(26, 77, 46, 0.8));
    z-index: 1;
  }
`;
...
const VerifyEmail = () => {
  ...
  return (
    <Background>     
      ...
      >
  <BackButton to="/seconnecter">
              <FaArrowLeft />
            </BackButton>
        <Title>🔐 Vérification de l'email</Title>
        <Text>
          Un code vous a été envoyé par email. Entrez-le ci-dessous pour activer votre compte de manière sécurisée.
        </Text>
