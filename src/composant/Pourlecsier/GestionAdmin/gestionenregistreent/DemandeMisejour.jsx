...
function DemandeMisejour() {
  ...
  useEffect(() => {
    const fetchDemande = async () => {
      try {
        const response = await fetch(`http://localhost:2027/api/demande/by-id/${id}`);
  ...
  return (
    <Container>
      <Header>
        ...
        <Title>Détails de la demande #{demande.reference}</Title>
        {!isEditing ? (
          ...
          <>
            ...
            <EditButton onClick={handleCancel} style={{ background: colors.error, color: 'white' }}>
              Annuler
            </EditButton>
          </>
        )}
          ...
          <InfoItem>
            ...
            <InfoContent>
              ...
              {demande.contactInfo?.piece1 ? (
                <DownloadButton
                  href={`http://localhost:2027/${path.basename(demande.contactInfo.piece1)}`}
                  target="_blank"
          ...
          <InfoItem>
            ...
            <InfoContent>
              ...
              {demande.contactInfo?.piece2 ? (
                <DownloadButton
                  href={`http://localhost:2027/${path.basename(demande.contactInfo.piece2)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Download size={16} />
        ...
        <InfoGrid>
          <InfoItem>
            ...
            <InfoContent>
              ...
              <Value>{new Date(demande.createdAt).toLocaleString("fr-FR")}</Value>
            </InfoContent>
          </InfoItem>
          {demande.updatedAt && (
            <InfoItem>
